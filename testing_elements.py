...
consent = Argument(id=8, type='actor', name='?character', arg_pos_dict = {excavate.id: 1})
item = Argument(id = 9, type='var', name='?item', arg_pos_dict={excavate.id : 2})
place = Argument(id = 10, type='var', name='?place',arg_pos_dict= {excavate.id : 3})
...
Example_graph = Graph(id = 1, type='step', Elements = example_elements, Edges = example_edges, Constraints = example_constraints)
