...
print('\nabsolvancy test: kill')
print(kill_clone_6000.canAbsolve(PARTIAL_KILL_ACTION))
print('\n')
...
for element in plan.elements:
	if type(element) is Operator:
		if element.name == 'excavate':
			instantiated_excavate_action = plan.getElementGraphFromElement(element,Action)

instantiated_excavate_action.print_graph()
for c in instantiated_excavate_action.constraints:
	c.print_edge()
			
print('\nabsolvancy test: excavate')
print(excavate_clone_9500.canAbsolve(instantiated_excavate_action))
print('\n')
